...
(function (window, document, ionic) {
    ...
    (function () {
        ...
        var keys = ['webkitTransform', 'transform', '-webkit-transform', 'webkit-transform', '-moz-transform', 'moz-transform', 'MozTransform', 'mozTransform'];
...
(function (ionic) {
    ...
    ionic.views.TabBarItem = ionic.views.View.inherit({
        ...
        _buildItem: function () {
            var _this = this,
                child, children = Array.prototype.slice.call(this.el.children);

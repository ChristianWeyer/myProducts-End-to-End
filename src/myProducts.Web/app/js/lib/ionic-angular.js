...
function ($rootScope, $document, $compile, $animate, $timeout, TemplateLoader) {
    ...
    return {
        ...
        show: function (opts) {
            ...
            var sheet = new ionic.views.ActionSheet({
                el: element[0]
            });
            scope.sheet = sheet;
    ...
    .factory('Popup', ['$rootScope', '$document', '$compile', 'TemplateLoader', function ($rootScope, $document, $compile, TemplateLoader) {
        ...
        return {
            alert: function (message, $scope) {
                ...
                var popup = new ionic.views.Popup({
                    el: element[0]
                });
                popup.alert(message);
...
(function () {
    ...
    function setViewportCss(viewport) {
        ...
        style = window.getComputedStyle ? window.getComputedStyle(viewport[0]) : viewport[0].currentStyle,

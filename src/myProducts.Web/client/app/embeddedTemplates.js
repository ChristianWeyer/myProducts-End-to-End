...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('login/login.html',
    '<div class=container><div class=login-container><div class=avatar></div><div class=form-box><form name=form novalidate><oauth site=https://localhost/ngmd/idsrv authorize-path=/connect/authorize client-id=myp-implicitclient redirect-uri="https://localhost/ngmd/client/" scope=default template=libs/60_oauth-ng/views/templates/default.html storage=localStorage></oauth></form></div></div></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('statusBar/statusBar.html',
    '<footer id=footer ng-cloak=""><div class=container-fluid><div ng-if=!status.isOnline class="circle-red pull-left"></div><div ng-if=status.isOnline class="circle-green pull-left"></div><span class=pull-right><oauth site=https://localhost/ngmd/idsrv authorize-path=/connect/authorize client-id=myp-implicitclient redirect-uri="https://localhost/ngmd/client/" scope=default template=libs/60_oauth-ng/views/templates/default.html storage=localStorage></oauth></span></div></footer>');
}]);
})();

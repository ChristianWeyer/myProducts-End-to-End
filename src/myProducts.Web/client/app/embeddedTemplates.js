...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('login/login.html',
    '<div class=container><div class=login-container><div class=avatar></div><div class=form-box><form name=form novalidate><oauth site=https://localhost/ngmd/idsrv authorize-path=/connect/authorize client-id=myp-implicitclient redirect-uri="https://localhost/ngmd/client/" scope=default template=libs/oauth-ng/views/templates/default.html></oauth></form></div></div></div>');
}]);
})();

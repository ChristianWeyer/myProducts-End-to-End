...
MSApp.execUnsafeLocalFunction(function () {	div.innerHTML = "<div class='a'></div><div class='a i'></div>";});
...
MSApp.execUnsafeLocalFunction(function () {		div.innerHTML = "<select t=''><option selected=''></option></select>";});
...
MSApp.execUnsafeLocalFunction(function () {div.innerHTML = "<a href='#'></a>";});
...
MSApp.execUnsafeLocalFunction(function () {div.innerHTML = "<input/>";});
...
MSApp.execUnsafeLocalFunction(function () {div.innerHTML = "<input type='radio' checked='checked' name='t'/>";});
	...
	// Support: IE9-IE11+
MSApp.execUnsafeLocalFunction(function () {div.innerHTML = "<textarea>x</textarea>";});
...
MSApp.execUnsafeLocalFunction(function () {				tmp.innerHTML = wrap[ 1 ] + elem.replace( rxhtmlTag, "<$1></$2>" ) + wrap[ 2 ];});
			...
			if ( typeof value === "string" && !rnoInnerhtml.test( value ) &&
				...
				try {
					for ( ; i < l; i++ ) {
						...
						if ( elem.nodeType === 1 ) {
							jQuery.cleanData( getAll( elem, false ) );
MSApp.execUnsafeLocalFunction(function () {						elem.innerHTML = value;});
						}
					}
...
MSApp.execUnsafeLocalFunction(function () {			div.innerHTML = "";});
